...
const App: React.FC = () => {
  ...
  const [structuredData, setStructuredData] = useState<
    StructuredAnalysisData | undefined
  >(undefined);
  const [error, setError] = useState<string | null>(null);
  const [showKeyModal, setShowKeyModal] = useState<boolean>(true);
  const [sectorContext, setSectorContext] = useState<"India" | "Global">(
    "India"
  );
  ...
  const handleAnalyze = async () => {
    ...
    try {
      const result = await analyzeStock(
        ...
        selectedPrompt.id,
        stockName,
        selectedPrompt.category === AnalysisCategory.SECTOR
          ? sectorContext
          : undefined
      );
  ...
  const getCategoryIcon = (category: AnalysisCategory) => {
    switch (category) {
      case AnalysisCategory.FINANCIAL:
        return (
          <svg
            className="w-6 h-6"
            fill="none"
      ...
      case AnalysisCategory.ANNUAL_REPORT:
        return (
          <svg
            className="w-6 h-6"
            fill="none"
      ...
      case AnalysisCategory.FORENSIC:
        return (
          <svg
            className="w-6 h-6"
            fill="none"
      ...
      case AnalysisCategory.TECHNICAL:
        return (
          <svg
            className="w-6 h-6"
            fill="none"
    ...
    <div className="flex h-screen bg-gray-950 text-gray-300 font-sans overflow-hidden selection:bg-blue-500/30">
      ...
      <Sidebar
        onSelectPrompt={(p) => {
          ...
          setSectorContext("India"); // Reset context default
        }}
          ...
          <div className="absolute inset-0 bg-black/80 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
            <div className="bg-gray-800 p-8 rounded-2xl shadow-2xl border border-gray-700 w-full max-w-md transform transition-all scale-100">
              ...
              <p className="text-gray-400 text-sm mb-6">
                Enter your Gemini API key to access professional-grade AI
                analysis.
              </p>
              <input
                type="password"
              ...
              <div className="flex justify-end">
                <button
                  ...
                  className="bg-blue-600 hover:bg-blue-500 text-white font-medium px-6 py-2.5 rounded-lg shadow-lg shadow-blue-900/20 transition-all hover:scale-105"
                >
                  Start Analyzing
                </button>
              </div>
                  ...
                  <div>
                    <div className="flex justify-between items-end mb-3">
                      ...
                      {isSectorAnalysis && (
                        <div className="flex items-center gap-2 bg-gray-900/50 p-1 rounded-lg border border-gray-700/50">
                          <button
                            onClick={() => setSectorContext("India")}
                          ...
                          <button
                            onClick={() => setSectorContext("Global")}
                            className={`px-3 py-1 text-[10px] font-bold uppercase tracking-wider rounded transition-all ${
                              sectorContext === "Global"
                                ? "bg-blue-600 text-white shadow-lg shadow-blue-900/40"
                                : "text-gray-400 hover:text-gray-200"
                            }`}
                          >
                    ...
                    <div className="flex gap-3">
                      <input
                        ...
                        placeholder={
                          isSectorAnalysis
                            ? "e.g. Green Hydrogen, PSU Banks, EV Batteries"
                            : "e.g. RELIANCE, TSLA, HDFCBANK"
                        }
              ...
              <div className="max-w-7xl mx-auto p-8 relative z-10">
                ...
                <div className="text-center py-16">
                  ...
                  <p className="text-xl text-gray-400 max-w-2xl mx-auto leading-relaxed">
                    AnalystGPT aggregates data from Annual Reports, Concalls,
                    and Financials to build professional investment thesis in
                    seconds.
                  </p>
                </div>
